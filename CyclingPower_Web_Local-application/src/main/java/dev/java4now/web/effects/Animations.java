...
package dev.java4now.web.effects;
...
public final class Animations {
    ...
    public static Timeline wobble(Node node) {
        ...
        var t = new Timeline(
            ...
            new KeyFrame(Duration.millis(150),
                new KeyValue(node.translateXProperty(), -0.25 * node.getParent().getBoundsInLocal().getWidth(), EASE),
                new KeyValue(node.rotateProperty(), -5, EASE)
            ),
            new KeyFrame(Duration.millis(300),
                new KeyValue(node.translateXProperty(), 0.2 * node.getParent().getBoundsInLocal().getWidth(), EASE),
                new KeyValue(node.rotateProperty(), 3, EASE)
            ),
            new KeyFrame(Duration.millis(450),
                new KeyValue(node.translateXProperty(), -0.15 * node.getParent().getBoundsInLocal().getWidth(), EASE),
                new KeyValue(node.rotateProperty(), -3, EASE)
            ),
            new KeyFrame(Duration.millis(600),
                new KeyValue(node.translateXProperty(), 0.1 * node.getParent().getBoundsInLocal().getWidth(), EASE),
                new KeyValue(node.rotateProperty(), 2, EASE)
            ),
            new KeyFrame(Duration.millis(750),
                new KeyValue(node.translateXProperty(), -0.05 * node.getParent().getBoundsInLocal().getWidth(), EASE),
    ...
    public static Timeline fadeInDown(Node node, Duration duration) {
        ...
        var t = new Timeline(
            new KeyFrame(Duration.ZERO,
                new KeyValue(node.opacityProperty(), 0, EASE),
                new KeyValue(node.translateYProperty(), -node.getParent().getBoundsInLocal().getHeight(), EASE)
            ),
    ...
    public static Timeline fadeInLeft(Node node, Duration duration) {
        ...
        var t = new Timeline(
            new KeyFrame(Duration.ZERO,
                new KeyValue(node.opacityProperty(), 0, EASE),
                new KeyValue(node.translateXProperty(), -node.getParent().getBoundsInLocal().getWidth(), EASE)
            ),
            new KeyFrame(duration,
                new KeyValue(node.opacityProperty(), 1, EASE),
                new KeyValue(node.translateXProperty(), 0, EASE)
